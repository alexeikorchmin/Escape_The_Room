...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (enableSprint)
        {
            ...
            {
                isZoomed = false;
                playerCamera.m_Lens.FieldOfView = Mathf.Lerp(playerCamera.m_Lens.FieldOfView, sprintFOV, sprintFOVStepTime * Time.deltaTime); // My Comment*****************************
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.playerCamera = (CinemachineVirtualCamera)EditorGUILayout.ObjectField(new GUIContent("Camera", "Camera attached to the controller."), fpc.playerCamera, typeof(CinemachineVirtualCamera), true); // My Comment*****************************
